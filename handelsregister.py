...
class HandelsRegister:
    ...
    def companyname2cachename(self):
        ...
        return self.cachedir / args.schlagwoerter

    def search_company(self):
        cachename = self.companyname2cachename()
        if args.force == None and cachename.exists():
            ...
            with open(self.cachedir / args.schlagwoerter, "w") as f:
                f.write(html)
...
if __name__ == "__main__":
    ...
    h.open_startpage()
    h.search_company()
    companies = get_companies_in_searchresults(h.companyname2cachename())
    for c in companies:
        pr_company_info(c)
